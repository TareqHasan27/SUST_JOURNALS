  ...
  return (
    <div className="bg-white shadow-md rounded-xl p-6 flex justify-between items-start">
      <div className="flex gap-6">
        <div className="w-24 h-24 bg-blue-100 text-blue-700 text-3xl font-bold rounded-lg flex items-center justify-center">
          <img src="https://images.unsplash.com/photo-1761839257870-06874bda71b5?ixlib=rb-4.1.0&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1169" alt="Profile" className="w-24 h-24 rounded-lg" />
        </div>
        <div>
