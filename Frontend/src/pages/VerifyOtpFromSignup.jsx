...
const VerifyOtpFromSignup = () => {
  ...
  // if the previous route sent a state like { from: 'register' } we'll treat that as registration flow
                ...
                isVerified ? (
                  <div className='py-6 flex flex-col items-center justify-center text-center space-y-4'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <p className='text-muted-foreground'>Your email has been verified. You'll be redirected shortly.</p>
                    </div>
